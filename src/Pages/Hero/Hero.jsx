    ...
    <div className="container flex flex-col px-6 py-4 mx-auto space-y-6 lg:h-[32rem] lg:py-16 lg:flex-row lg:items-center">
      <div className="flex items-center justify-center w-full h-96 lg:w-1/2">
        <img
          ...
          src="https://i.ibb.co/Mk3D6XN/confident-smiling-young-businesswoman-with-his-two-colleagues-holding-blank-placard-1.jpg"
          alt="apple watch photo"
        />
        <h1 className="absolute w-1/6 lg:text-2xl font-bold tracking-wide pt-32 text-cyan-500 pl-2 font-serif">
